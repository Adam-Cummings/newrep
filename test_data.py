...
def getPersonSkillTestData():
    return \
        ...
        '{"EmployeeSkillID":"52", "EmployeeID":"13", "SkillID":"30", "SkillLevel":"3", "CategoryID":"31"}]'


def getProjectTestData():
    return '[{"ProjectID":"39", "Name":"Project Mystery [skill 5 required]", "Client":"Mr Client", "Status":"0", "NumberOfPeople":"3", "StartDate":"2013-05-12", "EndDate":"2013-05-20"}, ' \
           '{"ProjectID":"40", "Name":"Project X [skill 1-3 required]", "Client":"Zarglax, Destroyer of Worlds", "Status":"0", "NumberOfPeople":"3", "StartDate":"2013-05-12", "EndDate":"2013-05-20"}, ' \
           '{"ProjectID":"41", "Name":"Project Banal [skill 4 required]", "Client":"The Best Client", "Status":"0", "NumberOfPeople":"3", "StartDate":"2013-05-12", "EndDate":"2013-05-20"}]'


def getProjectSkillTestData():
    return '[{"ProjectSkillID":"98", "ProjectID":"39", "SkillID":"30", "LevelMin":"5", "LevelMax":"5", "CategoryID":"31"}, ' \
           '{"ProjectSkillID":"97", "ProjectID":"40", "SkillID":"30", "LevelMin":"1", "LevelMax":"3", "CategoryID":"31"}, ' \
